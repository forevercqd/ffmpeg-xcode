...
FFMPEG_CONFIG_MAK=1
FFMPEG_CONFIGURATION=--prefix=./build/mac --enable-debug --disable-yasm
prefix=./build/mac
...
CC_IDENT=Apple clang version 11.0.0 (clang-1100.0.33.16)
ARCH=x86
INTRINSICS=none
CC=gcc
CXX=g++
...
EXTRALIBS=-framework CoreVideo -framework Foundation -framework AVFoundation -framework CoreMedia -framework CoreFoundation -framework VideoToolbox -framework CoreMedia -framework QuartzCore -framework CoreVideo -framework CoreFoundation -framework VideoDecodeAcceleration -framework QuartzCore -liconv -Wl,-framework,CoreFoundation -Wl,-framework,Security -framework CoreGraphics -lm -llzma -lbz2 -lz -pthread -framework CoreServices 
COMPAT_OBJS=
EXEOBJS=
INSTALL=install
LIBTARGET=
